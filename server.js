...
const routes = {
  ...
  '/api/clients/directory': () => import('./api/clients/directory.js'),
  '/api/phase-events': () => import('./api/phase-events.js'),
  '/api/proposals': () => import('./api/proposals.js'),
  '/api/proposals/summarize': () => import('./api/proposals/summarize.js'),
  ...
  '/api/portal/verify-code': () => import('./api/portal/[action].js'),
  '/api/portal/login-password': () => import('./api/portal/[action].js'),
  '/api/portal/set-password': () => import('./api/portal/[action].js'),
